...
options_no_group_name = {
  ...
  'various': ('Various', None, (
    ...
    ('language_default', 'zh', "Default language for user interface and page content, see HelpOnLanguages."),
    ('language_ignore_browser', True, "if True, ignore user's browser language settings, see HelpOnLanguages."),
